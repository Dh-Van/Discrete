...
\begin{itemize}
    ...
    \item \textbf{Main points:} Based on group discussions, we felt that the main point of this problem was to understand how to prove that the closed form and recurrence relation are equal to each other (using induction).
\end{itemize}
