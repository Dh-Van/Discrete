...
\begin{itemize}
    ...
    \item \textbf{Main points:} Based on group discussions, we felt that the main point of this problem was to use state counting (even/odd) to convert a global constraint into a simple recurrence
\end{itemize}
